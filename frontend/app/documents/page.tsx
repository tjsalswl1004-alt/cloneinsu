...
export default function Documents() {
  ...
  return (
    <div className="p-4 space-y-4">
      <div className="sticky top-0 z-10 bg-white border-b border-gray-100 -mx-4 -mt-4 mb-4 px-4 py-3 relative flex items-center justify-center">
        <button onClick={() => router.back()} className="absolute left-4 text-gray-500 text-2xl font-light leading-none">‹</button>
        <h1 className="text-base font-bold text-gray-900">청구서류 안내</h1>
      </div>
