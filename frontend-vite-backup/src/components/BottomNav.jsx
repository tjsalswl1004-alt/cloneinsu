...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 flex items-center justify-around h-16 max-w-lg mx-auto px-2 z-50">
      {NAV_ITEMS.map((item) =>
        item.isCenter ? (
          <button
            key={item.path}
          ...
          >
            <item.Icon color={pathname === item.path ? '#4F6EF7' : '#9CA3AF'} />
